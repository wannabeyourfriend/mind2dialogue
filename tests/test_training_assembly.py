"""Tests for student-view conversation assembly and retained metadata."""
...
class TestRolloutShape:
    """Student input for rewritten-prompt rollouts."""
    ...
    def test_rollout_metadata_key_order(self):
        config = AblationConfig.full()
        out = build_training_instance(_basic_session(), config)
...
class TestDeepScenarioShape:
    """Student input for scenario-seeded rollouts."""
