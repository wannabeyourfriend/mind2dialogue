...
(oracle or oracle_profile_only) through up to `max_turns` turns,
...
async def rollout_conversation(
    ...
    Assistant: Oracle with profile and, in the full condition, the user state.
    ...
    if config.use_user_state:
        current_state = _INITIAL_STATE.format(
